...
d3.tsv("data/measure.csv", function (che_data) {    
    ...
    // for pieChart
    var lucidPieDimension = lucidFilterData.dimension(function (d,i) {  return d.Description;});    
    var lucidPieDimensionGroup = lucidPieDimension.group();
    
    //define for row chart 
    var lucidRowChartDimension = lucidFilterData.dimension(function(d){ return d.Description; });       
